...
<html>
	...
	<body>
		...
		<div id="main">
			...
			<div id="bottomOption">
				<div class="hidden">
					<input type="text" name="os" value="android"/>
					<input type="text" name="ds" value="y"/>
				...
				<div class="justOption">
					...
					<div class="wrapperOption">
						...
						<div class="expandOption" id="bat_option">
							...
							<div class="optionDetail">
								...
								<!-- <div id="bat_>4rb mAh_> 4000 mAH" class="optionO">&gt; 4000 mAH</div> -->
							</div>
						</div>
					...
					<!-- <div class="wrapperOption">
						...
						<div class="expandOption" id="dr_option">
							<div class="litteArrow"></div>
							<div class="optionDetail">
								<div id="dr_d_none" class="optionO">none</div>
								<div id="dr_y_Ya" class="optionO">Ya</div>
		...
		<div id="headerPage">
			<a href="spesifikasi.php" class="aLogo"><div id="logoPage">
